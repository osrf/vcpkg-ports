...
foreach(SHARE_FILE ${SHARE_FILES})
  ...
  string(REPLACE "PATH_SUFFIXES \"OGRE\"" "PATH_SUFFIXES \"OGRE-2.2\"" _contents "${_contents}")
  ...
  string(REPLACE "set(OGRE_LIB_SEARCH_PATH \${dir}/lib" "set(OGRE_LIB_SEARCH_PATH \${dir}/lib/OGRE-2.2/manual-link" _contents "${_contents}")
  ...
  # Adjust library dirs to OGRE-2.2 and manual-link path origin
  string(REPLACE "\${COMPONENT} OGRE/\${COMPONENT}" "\${COMPONENT} OGRE-2.2/\${COMPONENT}" _contents "${_contents}")
...
# Copy dlls
file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/bin/OGRE-2.2)
file(GLOB MAIN_REL ${CURRENT_PACKAGES_DIR}/bin/Release/* ${CURRENT_PACKAGES_DIR}/bin/Debug/*)
file(COPY ${MAIN_REL} DESTINATION ${CURRENT_PACKAGES_DIR}/bin/OGRE-2.2/)
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/bin/Release/  ${CURRENT_PACKAGES_DIR}/bin/Debug/)

# Copy OgreMain.lib to manual-link
file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/manual-link)
file(GLOB MAIN_LIB_REL ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/Release/OgreMain.lib ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/Debug/OgreMain*.lib)
file(COPY ${MAIN_LIB_REL} DESTINATION ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/manual-link)
file(REMOVE ${MAIN_LIB_REL})

# Copy all .lib files to
file(GLOB LIBS_REL DESTINATION ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/Release/* ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2/Debug/*)
file(COPY ${LIBS_REL} DESTINATION ${CURRENT_PACKAGES_DIR}/lib/OGRE-2.2)
